  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        onPointerenter: [($event) => $event && _ctx.$volar ? _ctx.$volar.highlight($event.target, _ctx.$.type.__file, [2, 4, 462, 12]) : void 0, ($event) => $event && _ctx.$volar ? _ctx.$volar.highlight($event.target, _ctx.$.type.__file, [2, 4, 462, 12]) : void 0],
        ...
        onVnodeMounted: [($event) => $event && _ctx.$volar ? _ctx.$volar.vnodeMounted($event.el, _ctx.$.type.__file, [2, 4, 462, 12]) : void 0, ($event) => $event && _ctx.$volar ? _ctx.$volar.vnodeMounted($event.el, _ctx.$.type.__file, [2, 4, 462, 12]) : void 0],
...
//# sourceMappingURL=error-404-522046db.mjs.map
