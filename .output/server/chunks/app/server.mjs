...
const unhead_1n9wYxRQwi = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const router_nF0YuhSKsU = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:router",
  enforce: "pre",
  setup(nuxtApp) {
...
const revive_payload_server_8M2NX4gYpT = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  unhead_1n9wYxRQwi,
  router_nF0YuhSKsU,
  revive_payload_server_8M2NX4gYpT,
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_NuxtWelcome, {
    onPointerenter: [($event) => $event && _ctx.$volar ? _ctx.$volar.highlight($event.target, _ctx.$.type.__file, [3, 3, 5, 20]) : void 0, ($event) => $event && _ctx.$volar ? _ctx.$volar.highlight($event.target, _ctx.$.type.__file, [3, 3, 5, 20]) : void 0],
    onPointerleave: [($event) => $event && _ctx.$volar ? _ctx.$volar.unHighlight($event.target) : void 0, ($event) => $event && _ctx.$volar ? _ctx.$volar.unHighlight($event.target) : void 0],
    onVnodeMounted: [($event) => $event && _ctx.$volar ? _ctx.$volar.vnodeMounted($event.el, _ctx.$.type.__file, [3, 3, 5, 20]) : void 0, ($event) => $event && _ctx.$volar ? _ctx.$volar.vnodeMounted($event.el, _ctx.$.type.__file, [3, 3, 5, 20]) : void 0],
    onVnodeUnmounted: [($event) => $event && _ctx.$volar ? _ctx.$volar.vnodeUnmounted($event.el) : void 0, ($event) => $event && _ctx.$volar ? _ctx.$volar.vnodeUnmounted($event.el) : void 0]
  }, null, _parent));
  _push(`</div>`);
}
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./_nuxt/error-404-522046db.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./_nuxt/error-500-a8b6f962.mjs').then((r) => r.default || r));
    const ErrorTemplate = is404 ? _Error404 : _Error;
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(ErrorTemplate), mergeProps({ statusCode: unref(statusCode), statusMessage: unref(statusMessage), description: unref(description), stack: unref(stack) }, _attrs, {
        onPointerenter: [($event) => $event && _ctx.$volar ? _ctx.$volar.highlight($event.target, _ctx.$.type.__file, [2, 2, 3, 79]) : void 0, ($event) => $event && _ctx.$volar ? _ctx.$volar.highlight($event.target, _ctx.$.type.__file, [2, 2, 3, 79]) : void 0],
        onPointerleave: [($event) => $event && _ctx.$volar ? _ctx.$volar.unHighlight($event.target) : void 0, ($event) => $event && _ctx.$volar ? _ctx.$volar.unHighlight($event.target) : void 0],
        onVnodeMounted: [($event) => $event && _ctx.$volar ? _ctx.$volar.vnodeMounted($event.el, _ctx.$.type.__file, [2, 2, 3, 79]) : void 0, ($event) => $event && _ctx.$volar ? _ctx.$volar.vnodeMounted($event.el, _ctx.$.type.__file, [2, 2, 3, 79]) : void 0],
        onVnodeUnmounted: [($event) => $event && _ctx.$volar ? _ctx.$volar.vnodeUnmounted($event.el) : void 0, ($event) => $event && _ctx.$volar ? _ctx.$volar.vnodeUnmounted($event.el) : void 0]
      }), null, _parent));
    };
  }
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.8.1_vite@4.5.0/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
        ...
        default: () => {
          if (unref(error)) {
            _push(ssrRenderComponent(unref(ErrorComponent), {
              error: unref(error),
              onPointerenter: [($event) => $event && _ctx.$volar ? _ctx.$volar.highlight($event.target, _ctx.$.type.__file, [3, 3, 5, 51]) : void 0, ($event) => $event && _ctx.$volar ? _ctx.$volar.highlight($event.target, _ctx.$.type.__file, [3, 3, 5, 51]) : void 0],
              onPointerleave: [($event) => $event && _ctx.$volar ? _ctx.$volar.unHighlight($event.target) : void 0, ($event) => $event && _ctx.$volar ? _ctx.$volar.unHighlight($event.target) : void 0],
              onVnodeMounted: [($event) => $event && _ctx.$volar ? _ctx.$volar.vnodeMounted($event.el, _ctx.$.type.__file, [3, 3, 5, 51]) : void 0, ($event) => $event && _ctx.$volar ? _ctx.$volar.vnodeMounted($event.el, _ctx.$.type.__file, [3, 3, 5, 51]) : void 0],
              onVnodeUnmounted: [($event) => $event && _ctx.$volar ? _ctx.$volar.vnodeUnmounted($event.el) : void 0, ($event) => $event && _ctx.$volar ? _ctx.$volar.vnodeUnmounted($event.el) : void 0]
            }, null, _parent));
          } else if (unref(islandContext)) {
            _push(ssrRenderComponent(unref(IslandRenderer), {
              context: unref(islandContext),
              onPointerenter: [($event) => $event && _ctx.$volar ? _ctx.$volar.highlight($event.target, _ctx.$.type.__file, [4, 4, 5, 74]) : void 0, ($event) => $event && _ctx.$volar ? _ctx.$volar.highlight($event.target, _ctx.$.type.__file, [4, 4, 5, 74]) : void 0],
              onPointerleave: [($event) => $event && _ctx.$volar ? _ctx.$volar.unHighlight($event.target) : void 0, ($event) => $event && _ctx.$volar ? _ctx.$volar.unHighlight($event.target) : void 0],
              onVnodeMounted: [($event) => $event && _ctx.$volar ? _ctx.$volar.vnodeMounted($event.el, _ctx.$.type.__file, [4, 4, 5, 74]) : void 0, ($event) => $event && _ctx.$volar ? _ctx.$volar.vnodeMounted($event.el, _ctx.$.type.__file, [4, 4, 5, 74]) : void 0],
              onVnodeUnmounted: [($event) => $event && _ctx.$volar ? _ctx.$volar.vnodeUnmounted($event.el) : void 0, ($event) => $event && _ctx.$volar ? _ctx.$volar.vnodeUnmounted($event.el) : void 0]
            }, null, _parent));
          } else if (unref(SingleRenderer)) {
            ssrRenderVNode(_push, createVNode(resolveDynamicComponent(unref(SingleRenderer)), {
              onPointerenter: [($event) => $event && _ctx.$volar ? _ctx.$volar.highlight($event.target, _ctx.$.type.__file, [5, 5, 5, 66]) : void 0, ($event) => $event && _ctx.$volar ? _ctx.$volar.highlight($event.target, _ctx.$.type.__file, [5, 5, 5, 66]) : void 0],
              onPointerleave: [($event) => $event && _ctx.$volar ? _ctx.$volar.unHighlight($event.target) : void 0, ($event) => $event && _ctx.$volar ? _ctx.$volar.unHighlight($event.target) : void 0],
              onVnodeMounted: [($event) => $event && _ctx.$volar ? _ctx.$volar.vnodeMounted($event.el, _ctx.$.type.__file, [5, 5, 5, 66]) : void 0, ($event) => $event && _ctx.$volar ? _ctx.$volar.vnodeMounted($event.el, _ctx.$.type.__file, [5, 5, 5, 66]) : void 0],
              onVnodeUnmounted: [($event) => $event && _ctx.$volar ? _ctx.$volar.vnodeUnmounted($event.el) : void 0, ($event) => $event && _ctx.$volar ? _ctx.$volar.vnodeUnmounted($event.el) : void 0]
            }, null), _parent);
          } else {
            _push(ssrRenderComponent(unref(AppComponent), {
              onPointerenter: [($event) => $event && _ctx.$volar ? _ctx.$volar.highlight($event.target, _ctx.$.type.__file, [6, 6, 5, 28]) : void 0, ($event) => $event && _ctx.$volar ? _ctx.$volar.highlight($event.target, _ctx.$.type.__file, [6, 6, 5, 28]) : void 0],
              onPointerleave: [($event) => $event && _ctx.$volar ? _ctx.$volar.unHighlight($event.target) : void 0, ($event) => $event && _ctx.$volar ? _ctx.$volar.unHighlight($event.target) : void 0],
              onVnodeMounted: [($event) => $event && _ctx.$volar ? _ctx.$volar.vnodeMounted($event.el, _ctx.$.type.__file, [6, 6, 5, 28]) : void 0, ($event) => $event && _ctx.$volar ? _ctx.$volar.vnodeMounted($event.el, _ctx.$.type.__file, [6, 6, 5, 28]) : void 0],
              onVnodeUnmounted: [($event) => $event && _ctx.$volar ? _ctx.$volar.vnodeUnmounted($event.el) : void 0, ($event) => $event && _ctx.$volar ? _ctx.$volar.vnodeUnmounted($event.el) : void 0]
            }, null, _parent));
          }
        },
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.8.1_vite@4.5.0/node_modules/nuxt/dist/app/components/nuxt-root.vue");
